...
jlcxx::TypeWrapper<gismo::gsBasis<double>> registerBasis(jlcxx::Module& mod) {
  ...
  basis.method(
      "elementInSupportOf", [](const Basis& basis, int j) { return basis.elementInSupportOf(j - 1); }, arg("j"));

  // Actives
  basis.method(
      "active!",
      [](const Basis& basis, JuliaVector u, gismo::gsMatrix<int>& out) {
  ...
  basis.method(
      "active!",
      [](const Basis& basis, JuliaMatrix u, gismo::gsMatrix<int>& out) {
  ...
  basis.method(
      "isActive", [](const Basis& basis, int i, JuliaVector u) { return basis.isActive(i - 1, wrapVector(u)); },
  ...
  // Eval
  basis.method(
      "eval!", [](const Basis& basis, JuliaVector u, gismo::gsMatrix<>& out) { basis.eval_into(wrapVector(u), out); },
      arg("basis"), arg("u"), arg("out"));
  basis.method(
      "_eval", [](const Basis& basis, JuliaVector u) { return basis.eval(wrapVector(u)); }, arg("basis"), arg("u"));

  basis.method(
      "evalSingle!",
      [](const Basis& basis, int i, JuliaVector u, gismo::gsMatrix<>& out) {
        basis.evalSingle_into(i - 1, wrapVector(u), out);
      },
      arg("basis"), arg("i"), arg("u"), arg("out"));

  basis.method(
      "evalSingle", [](const Basis& basis, int i, JuliaVector u) { return basis.evalSingle(i - 1, wrapVector(u)); },
      arg("basis"), arg("i"), arg("u"));
  ...
  basis.method(
      "evalFunc",
      [](const Basis& basis, JuliaVector u, JuliaVector coefs) {
  ...
  basis.method(
      "evalFunc",
      [](const Basis& basis, JuliaVector u, JuliaMatrix coefs) {
  ...
  // Eval Deriv
  basis.method(
      "deriv!", [](const Basis& basis, JuliaVector u, gismo::gsMatrix<>& out) { basis.deriv_into(wrapVector(u), out); },
      arg("basis"), arg("u"), arg("out"));
  ...
  basis.method(
      "derivSingle", [](const Basis& basis, int i, JuliaVector u) { return basis.derivSingle(i - 1, wrapVector(u)); },
      arg("basis"), arg("i"), arg("u"));
  ...
  basis.method(
      "deriv2!",
      [](const Basis& basis, JuliaVector u, gismo::gsMatrix<>& out) { basis.deriv2_into(wrapVector(u), out); },
      arg("basis"), arg("u"), arg("out"));
  ...
  basis.method(
      "deriv2Single",
      [](const Basis& basis, int i, JuliaVector u) { return basis.deriv2Single(i - 1, wrapVector(u))(0, 0); },
      arg("basis"), arg("i"), arg("u"));
  ...
  basis.method(
      "boundary",
      [](Basis& basis, short_t s) {
        auto out = basis.boundary(s);
        incrementByOne(out);
        return out;
      },
      arg("basis"), arg("s"));
